...
MemMaster is local-only. It stores review metadata in your notes and plugin settings in your Obsidian vault, and it does not send note content or recovery data to a remote service.
